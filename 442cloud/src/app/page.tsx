...
export default function PresentationPage() {
  ...
  className="
    ...
    /* MOBILE — mniejsza karta, aby się mieściła */
    w-full max-w-[300px] h-[260px] mx-auto

    /* DESKTOP / TABLET — powrót do oryginalnych wymiarów */
    md:max-w-none md:w-[420px] md:h-[520px]
...
<section className="relative min-h-screen snap-start flex items-center">
  <div className="relative z-10 w-full max-w-5xl mx-auto px-6 py-16">
    ...
    {/* DESKTOP / TABLET – poziomy timeline */}
    <div className="relative hidden md:flex mt-30 h-[260px]">
    {/* linia osi */}
      <div className="pointer-events-none absolute left-0 right-0 top-1/2 h-[2px] bg-gradient-to-r from-green-500/10 via-green-500/80 to-green-500/10" />

      <div className="relative flex w-full justify-between gap-8">
        <TimelineItem
          index={0}
          year="2024"
          text="idea to do something together"
        />
        <TimelineItem
          index={1}
          year="March 2025"
          text="442 Cloud officially created"
        />
        <TimelineItem
          index={2}
          year="May 2025"
          text="first project begin"
        />
        <TimelineItem
          index={3}
          year="December 2025"
    ...
    {/* MOBILE – zwykłe karty jedna pod drugą */}
    <div className="grid gap-4 mt-10 md:hidden">
  ...
  return (
    <div
      className="
        ...
        min-h-[460px] p-8 pt-12

        /* MOBILE: pozioma, kompaktowa karta */
        max-md:flex-row max-md:items-center max-md:text-left max-md:gap-4
        max-md:w-full max-md:min-h-[140px]
        max-md:p-4 max-md:pt-4
      "
    >
      {/* FOTO */}
      <div
        className="
          ...
          w-40 h-40 md:w-44 md:h-44 lg:w-60 lg:h-60 mb-10

          /* MOBILE: mniejsze i bez dolnego marginesu */
          max-md:w-20 max-md:h-20 max-md:mb-0
        "
      >
      ...
      {/* TEKSTY */}
      <div className="max-md:flex-1 max-md:flex max-md:flex-col max-md:justify-center max-md:ml-2">
        <h3
          className="
            font-semibold font-oxanium
            text-xl
...
function TimelineItem({
  ...
  return (
    <div className="relative flex-1">
      {/* KROPKA – dokładnie na osi */}
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
        <div className="w-3 h-3 rounded-full bg-green-400 border border-[#040915] shadow-[0_0_10px_rgba(74,222,128,0.9)]" />
      </div>
      ...
      {/* BOX NAD OSIĄ */}
        ...
        <div className="absolute left-1/2 -translate-x-1/2 -top-[50px]">
          <div className="bg-white/5 border border-white/10 rounded-xl px-4 py-3 max-w-[220px]">
            <p className="text-green-400 font-semibold font-oxanium text-m mb-1">
              {year}
            </p>
